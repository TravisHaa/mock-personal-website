          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex items-start gap-4 mb-3">
                {/* Company Logo */}
                <div className="flex-shrink-0 w-12 h-12 rounded-xl overflow-hidden bg-white">
                  <ImageWithFallback
                    src={exp.logo}
                ...
                {expandedId === exp.id && (
                  ...
                  >
                    ...
                    >
                      {/* Details */}
                      <div className="mb-6">
                        <div className="text-sm mb-3 text-black/80">What I did</div>
                        <ul className="space-y-2">
                          {exp.details.map((detail, i) => (
                            <li key={i} className="text-sm text-black/60 pl-4 relative before:content-['•'] before:absolute before:left-0 before:text-black/30">
                              {detail}
                            </li>
                          ))}
                        </ul>
                      ...
                      {/* Tech Stack */}
                      <div className="mb-4">
                        <div className="text-sm mb-3 text-black/80">Tech Stack</div>
