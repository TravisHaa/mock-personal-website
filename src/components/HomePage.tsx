...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const courseworkY = useTransform(scrollY, [800, 1600], [100, -50]);
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
          <div className="text-sm text-black/50">Scroll down to see my work</div>
      ...
      >
        <FocusInView>
          <h2 className="mb-12 text-black/90">Experience</h2>
        </FocusInView>
        <ExperienceSection />
      </motion.section>
      ...
      >
        <FocusInView>
          <h2 className="mb-12 text-black/90">Coursework</h2>
        </FocusInView>
        <CourseworkSection />
      </motion.section>
